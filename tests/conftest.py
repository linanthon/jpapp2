...
def mock_db():
    ...
    for attr in [
        ...
        "insert_book_init", "update_insert_book_status_uploaded", "update_insert_book_status_finished",
        "rollback_insert_book", "get_job_book", "get_job_book_list",
        "create_job_book_batch", "get_job_book_batch", "get_job_book_batch_items",
